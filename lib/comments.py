...
class Comments:
    ...
    def get_all_comments(self, app_url, accesss_token):
    ...
    def update_comment(self, app_url, accesss_token, comment_id, **kwargs):
        LOG.info("update_comment")
        request_headers = build_request_headers(accesss_token, content_type="application/json")
        payload = {}
